...
const ExperienceSection = () => {
  return (
    <section id="experience" className="relative min-h-screen flex items-center justify-center py-4 md:py-6 overflow-hidden snap-center bg-transparent">
      {/* Background Number */}
      <div className="absolute left-[-2%] md:left-[4%] top-[35%] md:top-[40%] text-[20vh] md:text-[28vh] font-black text-white/[0.1] select-none pointer-events-none tracking-tighter z-0">
        04
      </div>
